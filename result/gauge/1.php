...
/*---------*/
.four.rischio3 .needle {animation: fourspeed1 2s 1 both; animation-delay: 1s; display:block;}
.four.rischio2 .needle {animation: fourspeed2 2s 1 both; animation-delay: 1s; display:block;} 
.four.rischio1 .needle {animation: fourspeed3 2s 1 both; animation-delay: 1s; display:block;}
